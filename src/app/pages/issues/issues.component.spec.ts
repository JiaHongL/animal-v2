...
describe('IssuesComponent', () => {
  ...
  it('應該 宣告 app-button-group 元件 所需參數 與 預設值，issueStatusOptions 預設 全部，issueStatusOptions 排除 歸檔， queryIssues 串接 函式', () => {

    fixture = TestBed.createComponent(IssuesComponent);
    component = fixture.componentInstance;

    const expectedIssueStatusOptions = issueStatusOptions.filter(option => option.code !== IssueStatus.ARCHIVE);

    expect(component).toEqual(
      jasmine.objectContaining({
        currentIssuesStatus: IssueStatus.ALL,
        issueStatusOptions: expectedIssueStatusOptions,
        queryIssues: component.queryIssues
      })
    );
